...
/* =========================================================
   V22 — POLIMENTO PREMIUM / ADMIN COMPACTO / RELATÓRIO
   ========================================================= */
...
function baixarRelatorioSalaEmpreendedor() {
  ...
  gerarPdfSimplesNorteServic(`relatorio-sala-empreendedor-${new Date().toISOString().slice(0,10)}.pdf`, paginas);
}
